...
/**
 * Created by _rejiejay Date 2019年7月4日08:06:09
 * Description:测试类
 */
public class digitalSignatureTest extends BaseUtilsTests {
	...
	public void EncryptSignatureTest() {
		...
		try {
			...
			String timestamp = "1562207534681";
			String username = "rejiejay";
			String token = "c4ca4238a0b923820dcc509a6f75849b";
			testResults = digitalSignature.EncryptSignature(reqParam, timestamp, username, token); // 7KvKmB6K2d400lnbBnU4y24cIBzqWWZJ3x8LdHVSS8Dow2gCcdHOMt0EMGGoT3TVaElRhBGVE0eJctihZJl33O3tXCVdP3QVQ+OKQ2QdSZolzW2LvDZyxp3VagejXg/6
	...
	public void DecodeSignatureTest() {
		...
		try {
			...
			testResults = digitalSignature.DecodeSignature(reqParam, digitalSignatureEncodedString); // {"timestamp":"1562207534681","username":"rejiejay","token":"c4ca4238a0b923820dcc509a6f75849b"}
